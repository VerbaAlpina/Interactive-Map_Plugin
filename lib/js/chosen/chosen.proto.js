...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.highlight_option = function(option, normalizedSearchText, highlightRegex) {
      var i, poslength, startpos, text, _i, _j, _ref, _ref1;
      ...
      if (option.normalized_search_text !== option.search_text) {
        for (i = _i = 0, _ref = option.search_text.length - 1; _i <= _ref; i = _i += 1) {
          if (highlightRegex.test(this.normalize_search_text(option.search_text.substr(i))) === false) {
            startpos = i - 1;
            break;
          }
        }
        for (i = _j = 1, _ref1 = option.search_text.length - startpos; _j <= _ref1; i = _j += 1) {
          if (highlightRegex.test(this.normalize_search_text(option.search_text.substr(startpos, i))) !== false) {
            poslength = i;
            break;
          }
        }
      ...
      return option.search_text = text.substr(0, startpos) + '<em>' + text.substr(startpos);
    };

    AbstractChosen.prototype.winnow_results = function() {
      var escapedSearchText, highlightRegex, normalizedSearchText, option, regex, results, results_group, searchText, _i, _len, _ref;
